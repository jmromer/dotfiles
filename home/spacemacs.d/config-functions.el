  ...
  (with-eval-after-load 'company
    (if (boundp 'company-backends)
        (progn
          ...
          (add-to-list 'company-backends '(company-robe :with company-gtags company-capf company-yasnippet))
          (add-to-list 'company-backends '(company-anaconda :with company-jedi company-capf company-yasnippet))
          (add-to-list 'company-backends '(company-tern :with company-capf company-yasnippet))
          (add-to-list 'company-backends '(company-gtags :with company-capf company-yasnippet))
