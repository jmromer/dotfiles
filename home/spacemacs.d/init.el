...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (traad counsel helm projectile cider spaceline yasnippet-snippets yapfify yaml-mode xterm-color ws-butler winum which-key wgrep web-mode web-beautify volatile-highlights vmd-mode virtualenvwrapper vimrc-mode vimish-fold vi-tilde-fringe uuidgen use-package unfill toc-org tagedit symon swiper swift-mode string-inflection sql-indent spaceline-all-the-icons solarized-theme smex smeargle slim-mode shell-pop seeing-is-believing scss-mode sayid sass-mode rvm rufo ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocop rspec-mode robe reveal-in-osx-finder restart-emacs request-deferred realgud rbenv rainbow-delimiters queue pyvenv pytest pyenv-mode py-isort pug-mode projectile-rails pretty-mode powerline popwin pippel pipenv pip-requirements persp-mode pbcopy password-generator paradox ox-gfm overseer ov osx-trash osx-dictionary orgit org-projectile org-present org-pomodoro org-mime org-download org-bullets org-brain open-junk-file ob-swift ob-restclient ob-http nameless mwim multi-term move-text mmm-mode minitest markdown-toc magit-gitflow magit-gh-pulls macrostep lorem-ipsum livid-mode live-py-mode linum-relative link-hint less-css-mode launchctl json-mode js2-refactor js-doc ivy-xref ivy-rtags ivy-purpose ivy-hydra intero indent-guide importmagic impatient-mode hyde hy-mode hungry-delete hlint-refactor hl-todo hindent highlight-parentheses highlight-numbers highlight-indentation helm-make helm-core haskell-snippets graphviz-dot-mode google-translate google-c-style golden-ratio godoctor go-tag go-rename go-guru go-eldoc gnuplot gitignore-mode github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gist gh-md fuzzy font-lock+ flyspell-correct-ivy flycheck-rtags flycheck-pos-tip flycheck-mix flycheck-haskell flycheck-gometalinter flycheck-elm flycheck-credo flx-ido fill-column-indicator feature-mode eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-quickscope evil-org evil-numbers evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-commentary evil-cleverparens evil-args evil-anzu eshell-z eshell-prompt-extras esh-help engine-mode emmet-mode elm-mode elisp-slime-nav editorconfig dumb-jump dockerfile-mode disaster diminish diff-hl deft dash-at-point dante dactyl-mode cython-mode csv-mode counsel-projectile counsel-dash counsel-css company-web company-tern company-statistics company-rtags company-restclient company-quickhelp company-go company-ghci company-ghc company-cabal company-c-headers company-auctex company-anaconda command-log-mode column-enforce-mode coffee-mode cmm-mode clojure-snippets clojure-cheatsheet clj-refactor clean-aindent-mode clang-format cider-eval-sexp-fu chruby centered-cursor-mode bundler browse-at-remote bison-mode auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile alchemist aggressive-indent add-node-modules-path adaptive-wrap ace-window ace-link ac-ispell))))
(custom-set-faces
