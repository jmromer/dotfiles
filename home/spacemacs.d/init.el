...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets yapfify yaml-mode xterm-color ws-butler winum wgrep web-beautify volatile-highlights vmd-mode vimrc-mode vimish-fold vi-tilde-fringe uuidgen unfill traad virtualenvwrapper request-deferred toc-org symon swift-mode string-inflection sql-indent spray spaceline-all-the-icons all-the-icons memoize spaceline powerline solarized-theme smex smeargle shell-pop seeing-is-believing sayid rvm rufo ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocop rspec-mode robe rjsx-mode reveal-in-osx-finder restart-emacs request rbenv rainbow-delimiters pyvenv pytest pyenv-mode py-isort projectile-rails rake pretty-mode popwin pippel pipenv pip-requirements persp-mode pbcopy password-generator paradox ox-gfm overseer ov osx-trash osx-dictionary orgit org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download org-bullets org-brain open-junk-file ob-swift ob-restclient ob-http nameless mwim multi-term move-text mmm-mode minitest markdown-toc magithub markdown-mode ghub+ apiwrap magit-gitflow magit-gh-pulls macrostep lorem-ipsum livid-mode skewer-mode simple-httpd live-py-mode link-hint launchctl json-navigator hierarchy json-mode json-snatcher json-reformat js2-refactor js2-mode js-doc ivy-xref ivy-rtags ivy-purpose window-purpose imenu-list ivy-hydra intero indent-guide importmagic epc ctable concurrent deferred hyde hungry-delete htmlize hlint-refactor hl-todo hindent highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-make haskell-snippets groovy-mode groovy-imports graphviz-dot-mode google-translate google-c-style golden-ratio godoctor go-tag go-rename go-guru go-eldoc gnuplot gitignore-mode github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter gist gh marshal logito pcache ht gh-md fuzzy flyspell-correct-ivy flyspell-correct flycheck-rtags flycheck-pos-tip flycheck-mix flycheck-haskell flycheck-gometalinter flycheck-elm flycheck-credo flx-ido fill-column-indicator feature-mode eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-quickscope evil-org evil-numbers evil-matchit evil-magit magit magit-popup git-commit ghub with-editor evil-lisp-state evil-lion evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-commentary evil-cleverparens smartparens evil-args evil-anzu anzu eshell-z eshell-prompt-extras esh-help engine-mode emmet-mode elm-mode elisp-slime-nav editorconfig dumb-jump dockerfile-mode disaster diff-hl deft dash-at-point dante lcr flycheck dactyl-mode cython-mode csv-mode counsel-projectile projectile counsel-dash helm-dash counsel swiper ivy company-tern dash-functional tern company-statistics company-rtags rtags company-restclient restclient know-your-http-well company-quickhelp pos-tip company-go go-mode company-ghci company-ghc ghc haskell-mode company-flx flx company-cabal company-c-headers company-auctex company-anaconda command-log-mode column-enforce-mode cmm-mode clojure-snippets clojure-cheatsheet helm helm-core clj-refactor inflections edn multiple-cursors paredit peg clean-aindent-mode clang-format cider-eval-sexp-fu eval-sexp-fu highlight cider spinner queue clojure-mode chruby centered-cursor-mode bundler inf-ruby browse-at-remote bison-mode auto-yasnippet yasnippet auto-highlight-symbol auto-dictionary auto-compile packed auctex anaconda-mode pythonic f alchemist s company dash elixir-mode pkg-info epl aggressive-indent add-node-modules-path ace-window ace-link avy ac-ispell auto-complete popup which-key use-package pcre2el org-plus-contrib hydra font-lock+ exec-path-from-shell evil goto-chg undo-tree diminish bind-map bind-key async))))
(custom-set-faces
