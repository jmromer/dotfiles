...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     '(company-quickhelp yasnippet-snippets yapfify yankee yaml-mode xterm-color ws-butler writeroom-mode winum which-key web-mode volatile-highlights vmd-mode vimrc-mode vi-tilde-fringe uuidgen use-package unfill typo treemacs-projectile treemacs-persp treemacs-magit treemacs-evil toml-mode toc-org tide terminal-here tagedit symon symbol-overlay string-inflection sqlup-mode sql-indent spray spaceline-all-the-icons smeargle slim-mode shell-pop seeing-is-believing scss-mode sass-mode rvm rufo ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocopfmt rubocop rspec-mode ron-mode robe rjsx-mode reveal-in-osx-finder restclient-helm restart-emacs rbenv rainbow-delimiters racer pytest pyenv-mode py-isort pug-mode prodigy pretty-mode popwin pony-mode pippel pipenv pip-requirements pdf-tools password-generator parinfer paradox ox-twbs ox-hugo ox-gfm overseer ov osx-trash osx-dictionary osx-clipboard orgit org-superstar org-rich-yank org-re-reveal org-projectile org-pretty-table org-present org-pomodoro org-mime org-journal org-expand org-download org-cliplink org-brain org-books open-junk-file ob-restclient ob-http ob-elixir nov nodejs-repl nginx-mode nameless mwim multi-vterm multi-term move-text mmm-mode minitest markdown-toc magit-svn magit-section magit-gitflow macrostep lsp-ui lsp-python-ms lsp-pyright lsp-origami lsp-haskell lorem-ipsum livid-mode live-py-mode link-hint launchctl json-navigator js2-refactor js-doc insert-shebang indent-guide importmagic import-js impatient-mode ido-completing-read+ ibuffer-projectile hybrid-mode hungry-delete hlint-refactor hl-todo hindent highlight-parentheses highlight-numbers helpful helm-xref helm-themes helm-swoop helm-rtags helm-pydoc helm-purpose helm-projectile helm-org-rifle helm-mode-manager helm-make helm-lsp helm-ls-git helm-hoogle helm-gtags helm-gitignore helm-git-grep helm-flx helm-descbinds helm-dash helm-css-scss helm-c-yasnippet helm-ag haskell-snippets gxref graphviz-dot-mode graphql-mode google-translate google-c-style golden-ratio godoctor go-tag go-rename go-impl go-guru go-gen-test go-fill-struct go-eldoc gnuplot gitignore-templates github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe gist gh-md ggtags fuzzy forge font-lock+ flyspell-correct-helm flycheck-ycmd flycheck-rust flycheck-rtags flycheck-pos-tip flycheck-package flycheck-ledger flycheck-haskell flycheck-elsa flycheck-elm flycheck-credo flycheck-bashate flx-ido fish-mode feature-mode eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-textobj-line evil-text-object-python evil-surround evil-rails evil-quickscope evil-org evil-numbers evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-ledger evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-commentary evil-collection evil-cleverparens evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help erlang engine-mode emr emojify emoji-cheat-sheet-plus emmet-mode elpy elm-test-runner elm-mode elisp-slime-nav editorconfig dumb-jump dotenv-mode doom-modeline dockerfile-mode docker disaster direnv dimmer diminish devdocs deft dash-at-point dap-mode dante dactyl-mode cython-mode csv-mode cpp-auto-include company-ycmd company-web company-shell company-rtags company-restclient company-reftex company-prescient company-jedi company-go company-emoji company-cabal company-c-headers company-box company-auctex company-anaconda command-log-mode column-enforce-mode coffee-mode cmm-mode clean-aindent-mode chruby centered-cursor-mode ccls cargo bundler browse-at-remote bm blacken beacon auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile auctex-latexmk attrap amx alchemist aggressive-indent add-node-modules-path ace-link ace-jump-helm-line ac-ispell))
