...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets yaml-mode web-mode pyvenv org-mime org-brain magithub link-hint js2-refactor intero hy-mode evil-magit editorconfig dockerfile-mode clj-refactor counsel haskell-mode helm helm-core magit ghub evil async org-plus-contrib yapfify xterm-color ws-butler winum which-key wgrep web-beautify volatile-highlights vmd-mode vimrc-mode vimish-fold vi-tilde-fringe uuidgen use-package unfill undo-tree traad toc-org tagedit symon swiper swift-mode string-inflection sql-indent spaceline-all-the-icons solarized-theme smex smeargle slim-mode shell-pop seeing-is-believing scss-mode sayid sass-mode rvm ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocop rspec-mode robe reveal-in-osx-finder restart-emacs realgud rbenv rainbow-delimiters pytest pyenv-mode py-isort pug-mode projectile-rails pretty-mode popwin pippel pipenv pip-requirements persp-mode pbcopy password-generator paradox ox-gfm overseer ov osx-trash osx-dictionary orgit org-projectile org-present org-pomodoro org-download org-bullets open-junk-file ob-swift ob-restclient ob-http nameless mwim multiple-cursors multi-term move-text mmm-mode minitest markdown-toc magit-gitflow magit-gh-pulls macrostep lorem-ipsum livid-mode live-py-mode linum-relative less-css-mode launchctl json-mode js-doc ivy-xref ivy-rtags ivy-purpose ivy-hydra indent-guide importmagic impatient-mode hyde hungry-delete hlint-refactor hl-todo hindent highlight-parentheses highlight-numbers highlight-indentation helm-make haskell-snippets groovy-mode groovy-imports graphviz-dot-mode goto-chg google-translate google-c-style golden-ratio godoctor go-tag go-rename go-guru go-eldoc gnuplot gitignore-mode github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gist ghub+ gh-md fuzzy font-lock+ flyspell-correct-ivy flycheck-rtags flycheck-pos-tip flycheck-mix flycheck-haskell flycheck-gometalinter flycheck-elm flycheck-credo flx-ido fill-column-indicator feature-mode eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-quickscope evil-org evil-numbers evil-matchit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-commentary evil-cleverparens evil-args evil-anzu eshell-z eshell-prompt-extras esh-help engine-mode emmet-mode elm-mode elisp-slime-nav edn dumb-jump disaster diminish diff-hl deft dash-at-point dante dactyl-mode cython-mode counsel-projectile counsel-dash counsel-css company-web company-tern company-statistics company-rtags company-restclient company-quickhelp company-go company-ghci company-ghc company-cabal company-c-headers company-auctex company-anaconda command-log-mode column-enforce-mode coffee-mode cmm-mode clojure-snippets clojure-cheatsheet clean-aindent-mode clang-format cider-eval-sexp-fu chruby centered-cursor-mode bundler browse-at-remote auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile alchemist aggressive-indent adaptive-wrap ace-window ace-link ac-ispell))))
(custom-set-faces
