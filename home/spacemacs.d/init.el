...
(defun dotspacemacs/user-config ()
  ...
  (setq counsel-rg-base-command "rg --column --no-heading")
  ...
  (setq ido-file-extensions-order '(".org" ".py" ".el"))
