...
" Vim session script.
" Created by session.vim 2.7 on 05 December 2014 at 21:23:01.
...
badd +9 features/codebreaker_starts_game.feature
badd +1 ~/Developer/mastermind
badd +1 features/support/env.rb
badd +0 features/step_definitions/mastermind.rb
argglobal
silent! argdel *
...
exe '1resize ' . ((&lines * 12 + 17) / 34)
exe '2resize ' . ((&lines * 5 + 17) / 34)
exe '3resize ' . ((&lines * 5 + 17) / 34)
...
wincmd w
argglobal
edit features/step_definitions/mastermind.rb
setlocal fdm=indent
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
