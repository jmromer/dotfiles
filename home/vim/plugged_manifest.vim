...
Plug 'Valloric/YouCompleteMe', { 'do': 'brew unlink python && ./install.py --clang-completer --gocode-completer && brew link python' }
...
Plug 'stefanoverna/vim-i18n', { 'for': ['ruby', 'haml', 'eruby'] }
