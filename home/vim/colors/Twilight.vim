...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("FoldColumn", "d2b48c", "NONE", "")
...
hi Search ctermfg=white ctermbg=237 cterm=NONE guifg=#141414 guibg=#6B8E23 gui=NONE
hi IncSearch ctermfg=yellow ctermbg=237 cterm=NONE guifg=#141414 guibg=#8f9d6a gui=NONE
...
" ---------------------------------------------------
" Vimdiff colors
highlight DiffAdd    ctermfg=white ctermbg=22
highlight DiffDelete ctermfg=NONE  ctermbg=52
highlight DiffChange ctermfg=NONE ctermbg=NONE
highlight DiffText   ctermfg=white ctermbg=22

" colors for folds
highlight Folded cterm=italic ctermbg=110 ctermfg=black
highligh Folded gui=italic guibg=#3467ff guifg=black
