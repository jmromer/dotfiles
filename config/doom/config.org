...
(map! :desc "pwd vterm"     "s-'"   #'vterm-other-window
      ...
      :desc "full vterm"    "s-C-'" #'(lambda () (interactive) (+vterm/here t))
         ...
         "s-n"   #'+new-emacs-instance
         "s-C-n" #'+org-capture/open-frame
         "s-s"   #'save-buffer
...
#+begin_src elisp
(defun +save-org-agenda-files (_change)
  (interactive)
  (org-save-all-org-buffers))

(after! org
  (add-hook! org-trigger #'+save-org-agenda-files))
#+end_src
...
(after! org
  (setq org-adapt-indentation t
        ...
        org-todo-keywords '((sequence "INBOX(i)" "TODO(t)" "WIP(w)" "|" "DONE(d)" "CANCELED(k)")
                            (sequence "   (I)" "[ ](T)" "[-](W)" "|" "[X](D)" "[~](K)"))
