...
(after! markdown-mode
  ...
  (add-hook! markdown-mode :append #'+config:keymaps:markdown))
#+end_src
...
TODO: Organize the default ones, they're a mess.
...
(after! org
  ...
  (defun +config:keybindings:org-mode ()
    ...
    (map! :map org-mode-map
          ...
          :ni "s-C-RET"      #'org-insert-subheading
          :ni "s-C-<return>" #'org-insert-subheading)
