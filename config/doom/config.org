...
(add-hook! markdown-mode #'+config:keymaps:markdown)
#+end_src
...
(add-hook! ruby-mode #'+config:keymaps:ruby)
#+end_src

#+begin_src elisp
;; clear projectile-rails's keybinds
(defun +config:keymaps:rails ()
...
(add-hook! ruby-mode #'+config:keymaps:rails)
#+end_src
...
(add-hook! ruby-mode #'+config:keymaps:rspec)
#+end_src
...
#+begin_src elisp
(defun +config:keymaps:xwidget-webkit ()
...
(add-hook! xwidget-webkit-mode #'+config:keymaps:xwidget-webkit)
#+end_src
