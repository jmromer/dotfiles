...
Unbind =rspec-mode= bindings that conflict with =ruby-test=.
...
(map! :map ruby-mode-map
      ...
      :ni "s-S-<return>" #'ruby-test-rerun
      :ni "s-S-RET"      #'ruby-test-rerun)

(map! :map ruby-mode-map
      :localleader
      :prefix ("t" . "test")
      :desc "all"         :n "a" #'rspec-verify-all
      :desc "buffer"      :n "b" #'ruby-test-run
      :desc "last"        :n "l" #'ruby-test-rerun
      :desc "last failed" :n "L" #'rspec-run-last-failed
      :desc "single"      :n "t" #'ruby-test-run-at-point)
#+end_src
