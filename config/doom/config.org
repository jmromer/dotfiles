...
(map! :map python-mode-map
      :localleader
      :desc "pipenv"      :n "e"     nil
      :desc "activate"    :n "e a"   #'pipenv-activate
      :desc "deactivate"  :n "e d"   #'pipenv-deactivate
      :desc "install"     :n "e i"   #'pipenv-install
      :desc "lock"        :n "e l"   #'pipenv-lock
      :desc "open module" :n "e o"   #'pipenv-open
      :desc "run"         :n "e r"   #'pipenv-run
      :desc "shell"       :n "e s"   #'pipenv-shell
      :desc "uninstall"   :n "e u"   #'pipenv-uninstall)
#+end_src
...
(map! :map python-mode-map
      :localleader
      :desc "virtualenv"     :n "v"   nil
      :desc "activate"       :n "v a" #'pyvenv-activate-venv-dwim
      :desc "deactivate"     :n "v d" #'pyvenv-deactivate
      :desc "restart python" :n "v r" #'pyvenv-restart-python)
#+end_src
